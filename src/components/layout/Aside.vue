    ...
    <div class="aside-wrapper">
        ...
        <div class="os-menu">
            ...
            <el-submenu index="1">
                ...
                <router-link to="/index/list"><el-menu-item index="1-1">菜单分类列表</el-menu-item></router-link>
                <router-link to="/index/food"><el-menu-item index="1-2">菜单明细</el-menu-item></router-link>
                <!-- </el-menu-item-group> -->
                <el-menu-item-group >
